    ...
    el-row
      ...
      el-col(:span="4")  
        el-form-item(label="method:" size="large")
          el-select(v-model="appStore.states.Method",placeholder="type",style="width: 100%;",size='large',@change='updateChart')
...
const updateChart = _.debounce(async () => {
  ...
  let response = await axios.post(
    "https://wiki.lmd.knogen.com:10443/api/mag/getMagRefSelfRate",
    // "https://wiki.nikepai.com/api/mag/getMagRefSelfRate",
    {
